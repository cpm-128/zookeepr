...
// export these functions so they can be referenced in server.js
//  NOTE: becuase these are exported here, they do not need to be required in server.js, sake of simple code
module.exports = {
    filterByQuery,
    findById,
    createNewAnimal,
